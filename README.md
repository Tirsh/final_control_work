...
13. Создать класс с [Инкапсуляцией методов и наследованием по диаграмме](./pet_project/src/Model).
14. [Написать программу](./pet_project), имитирующую работу реестра домашних животных.
...
15. Создайте класс [Счетчик](./pet_project/src/Services/Counter.java), у которого есть метод add(), увеличивающий̆
